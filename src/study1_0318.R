### 03/18/2020
### this script is to attempt conducting clustering using dimension-reduced df
### ...and use the clustering result to conduct LASSO
...
model_list.pc <- constructLogRegModelsFromClusters(data,saveModels = T,models_per_k = 100,cluster_min=1,
                                                   working_directory="C:/Users/ashle/R/study1/March18",
...
reg_models <- readRDS("C:/Users/ashle/R/study1/March18/log_reg_models.rds")
all_kmeans <- readRDS("C:/Users/ashle/R/study1/March18/k_cluster_models.rds")
...
# save data
saveRDS(all_coef_list, "C:/Users/ashle/R/study1/March18/reg_models_labeled.rds")
...
saveWorkbook(wb, "C:/Users/ashle/R/study1/March18/all_models_and_clusters_workbook_study1_labeled.xlsx")
...
reg_models_labeled <- readRDS("C:/Users/ashle/R/study1/March18/reg_models_labeled.rds")
...
# save data
saveRDS(reg_models_chosen, "C:/Users/ashle/R/study1/March18/reg_models_solution.rds")

# ---------------------------------------------------------------------------- #
# 4. Averaging to solve variability in cv-glmnet (added 03/18/2020)

#### instead of using the generated, we just here simulate 100 times (newly)
curr_kmean <- all_kmeans[[1]]
...
for (j in 1:length(curr_kmean$size)){
  ...
  beta = coef(fit, x=data, y=y, s=bestlambda/length(y), exact=TRUE)
  # compute fixed lambda p-values and selection intervals
  out = fixedLassoInf(data, (curr_kmean$cluster == j)*1, beta, bestlambda, family="binomial")
...
# save in csv
write.csv(all_coefs,"C:/Users/ashle/R/study1/March18/simulated.csv", row.names = TRUE)