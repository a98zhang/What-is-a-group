...
simulateClusterings <- function(data, models_per_k=100, k_range=3,
                               cluster_min=3,working_directory="~/r_files/clus",
                               saveModels=F) {
  ...
  # 0. set parameters
    ...
    # set the directory to save into as the working_directory specified
